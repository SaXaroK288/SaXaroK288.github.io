...
const translations = {
  ru: {
    ...
    'case.rank.may': 'Май · 13,78%',
    'case.rank.mar': 'Март · 14,86%',

    'certs.title': 'Сертификаты',
    'certs.hint': 'Пройденные курсы OpenAI Academy.',
    'cert1.name': 'AI Foundations',
    'cert1.desc': 'Основы ИИ, больших языковых моделей и ChatGPT — чёткие инструкции, полезный контекст, проверка результатов и ответственное использование ИИ в работе.',
    'cert2.name': 'Applied AI Foundations',
    'cert2.desc': 'Превращение повторяющейся задачи в повторяемый рабочий процесс — разбивка на шаги, поиск мест, где помогает ChatGPT, и встраивание точек проверки.',
